...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="index.php?pag=<?php echo $menu3 ?>">Animais</a>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseConsultas" aria-expanded="true" aria-controls="collapseUtilities">
                ...
                <div id="collapseConsultas" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="index.php?pag=<?php echo $menu8 ?>">Orçamentos</a>
                        <a class="collapse-item" href="index.php?pag=<?php echo $menu9 ?>">Serviços</a>
                        <a class="collapse-item" href="index.php?pag=<?php echo $menu6 ?>">Movimentações</a>
                        <a class="collapse-item" href="index.php?pag=<?php echo $menu7 ?>">Compras</a>

                        <a class="collapse-item" href="index.php?pag=<?php echo $menu10 ?>">Entrada Animais</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseRel" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a target="_blank" class="collapse-item" href="../rel/rel_animais.php">Animais paidepet</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <img class="" src="../img/loguinhopet.png" width="85">

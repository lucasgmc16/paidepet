...
$query_cat = $pdo->query("SELECT * FROM veterinarios  ");
$res_cat = $query_cat->fetchAll(PDO::FETCH_ASSOC);
$totalveterinarios = @count($res_cat);
	...
	<div class="col-xl-3 col-md-6 mb-4">
		<div class="card border-left-primary shadow h-100 py-2">
			<div class="card-body">
				<div class="row no-gutters align-items-center">
					<div class="col mr-2">
						<div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Total Veterinários</div>
						<div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo @$totalveterinarios ?> </div>
					</div>
					<div class="col-auto" align="center">
						<i class="fas fa-clipboard-list fa-2x text-primary"></i>
